...
public class AddProductController {
    ...
    @FXML private TextField nameT, inventoryLevelT, minT, maxT, priceT, searchPartsT;
    ...
    //constructor allows for passing of main controller to refresh product table and pass in new product to modify
    public AddProductController(Product product, MainController mc){
        this.product = product;
        this.mc = mc;
    }

    //refreshes all parts TableView on window open
    ...
    //add product to products ArrayList and refreshes product table
    @FXML private void saveButton(){
        ...
        try {
            ...
            if (min > max){
                ...
                product.setName(nameT.getText());
                product.setPrice(price);
                product.setInStock(inventoryLevel);
                product.setMin(min);
                product.setMax(max);
